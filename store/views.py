...
def product_detail(request, category_slug, product_slug):
    try:
        ...
        in_cart = CartItem.objects.filter(cart__cart_id = _cart_id(request), product = single_product).exists()  # cart is a foreign key in CartItem model and this is how we acces cart_id in Cart model
